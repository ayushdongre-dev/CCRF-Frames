  ...
  return (
    <div style={{ minHeight: '100%', display: 'flex', flexDirection: 'column', background: '#F9F8FC', animation: 'fadeIn .25s' }}>
      ...
      <div className="scr" style={{ flex: 1, overflowY: 'auto', padding: '20px 20px 8px' }}>
        ...
        {/* ── Status hero card ── */}
        <div style={{ background: c.bg, borderRadius: 22, padding: '20px', marginBottom: 16, boxShadow: '0 12px 32px -8px rgba(0,0,0,.25)', animation: 'fadeUp .35s both' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 20, padding: '18px 18px', boxShadow: '0 2px 16px rgba(0,0,0,.06)', marginBottom: 14, animation: 'fadeUp .35s .12s both' }}>
        ...
        {/* ── Loan summary ── */}
        <div style={{ background: '#fff', borderRadius: 20, padding: '16px 18px', boxShadow: '0 2px 16px rgba(0,0,0,.06)', animation: 'fadeUp .35s .2s both' }}>
