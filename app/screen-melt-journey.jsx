    ...
    <div style={{ minHeight: '100%', display: 'flex', flexDirection: 'column', background: '#fff', animation: 'fadeIn .3s' }}>
      ...
      <div style={{ flex: 1, padding: '10px 20px 26px' }}>
        ...
        <div style={{
          ...
          boxShadow: '0 18px 40px -16px rgba(26,20,56,.5)', marginBottom: 18,
        }}>
          <div style={{ position: 'absolute', top: -46, right: -36, width: 170, height: 170, borderRadius: '50%', background: 'radial-gradient(circle, rgba(127,85,223,.5) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      <BottomBar>
        <Btn onClick={function () { go('meltbank'); }}>
          Continue Repayment {Icon.arrowR('#fff')}
        </Btn>
      </BottomBar>
    </div>
  );
